...
BERT_PATH = "D:/pycharm project/pythonProject1/sentiment/roberta/roberta-base"
...
if __name__ == '__main__':
    ...
    tokenizer = RobertaTokenizerFast.from_pretrained(BERT_PATH, model_max_length=64)
    ...
    model = RobertaForSequenceClassification.from_pretrained(BERT_PATH)
